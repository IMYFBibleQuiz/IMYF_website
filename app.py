...
def generate_certificate_route():
    ...
    if registration_status:
        ...
        exam_codes={
            ...
            'Baihar Campus': 'Baihar Campus Gladwin Solomon, India Mission, \nGohara Village, Near Kopra Fatak Church, Baihar, \nMADHYA PRADESH 481105 Phone number: 7992356517 \nIncharge : Sohan Mahile, Mobile: +91 97536 25007',
            'Exam Center Madhupur':'India Mission, Madhupur village, \nSonbhadra Dist., Uttar Pradesh Pin 231216 Location-Near intercollege, \nChandan basti Phone number: 6392294765 \nIncharge : Besky Livingstone, Mobile: +91 8590976147',
